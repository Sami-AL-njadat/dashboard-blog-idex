...
<head>
    ...
    <!-- Title -->
    <title>idex - Admin &amp; Dashboard </title>
...
<body>
    ...
    <main id="content" role="main" class="main">
        <div class="position-fixed top-0 end-0 start-0 bg-img-start"
            style="height: 32rem; background-image: url({{ asset('dist/assets/svg/components/card-6.svg') }});">
            <!-- Shape -->
        ...
        <div class="container py-5 py-sm-7">
            <a class="d-flex justify-content-center mb-5" href="#">
                <img class="zi-2" src="{{ asseT('images/logoidex.png') }}" alt="Image Description"
                    style="width: 8rem;">
            </a>
                        ...
                        <form method="POST" action="{{ route('login') }}" id="loginForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input id="email" type="email" class="form-control form-control-lg" name="email"
                                    id="signinSrEmail" tabindex="1" aria-label="email@address.com"
